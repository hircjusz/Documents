...
UPDATE
"doTurnover" t1
SET "CreditDrop" = NVL((SELECT NVL(t2."Credit",0) FROM "doTurnover" t2 WHERE t2."Customer"=t1."Customer" and "Year"='2014' AND "Period"='M11'),0) - NVL(t1."Credit", 0)
...
SET "CreditDrop" = NVL((SELECT NVL(t2."Credit",0) FROM "doExcludedTurnover" t2 WHERE t2."Customer"=t1."Customer" and t2."ExcludedAccount"=t1."ExcludedAccount" and "Year"='2014' AND "Period"='M11'),0)
- NVL(t1."Credit", 0) 
WHERE "Year"='2014' AND "Period"='M12';
...
UPDATE
"doTurnover" t1
SET "CreditDrop" = NVL((SELECT NVL(t2."Credit",0) FROM "doTurnover" t2 WHERE t2."Customer"=t1."Customer" and "Year"='2014' AND "Period"='M12'),0) - NVL(t1."Credit", 0) 
...
UPDATE
"doExcludedTurnover" t1
SET "CreditDrop" = NVL((SELECT NVL(t2."Credit",0) FROM "doExcludedTurnover" t2 WHERE t2."Customer"=t1."Customer" and t2."ExcludedAccount"=t1."ExcludedAccount" and "Year"='2014' AND "Period"='M12'),0)
- NVL(t1."Credit", 0) 
WHERE "Year"='2015' AND "Period"='M01';
